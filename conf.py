...
BLOG_AUTHOR = "GISCE-TI, S.L."  # (translatable)
BLOG_TITLE = "GISCE-TI, S.L."  # (translatable)
...
BLOG_EMAIL = "web@gisce.net"
BLOG_DESCRIPTION = "GISCE-TI Especialitzats en el sector elèctric"  # (translatable)
...
# )
FAVICONS = (
    ("sortcut icon", "/favicon.ico", "16x16"),
    ("icon", "/favicon.ico", "16x16")
)
